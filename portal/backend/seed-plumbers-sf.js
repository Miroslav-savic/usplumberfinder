/**
 * seed-plumbers-sf.js
 * Seeds plumbers from San Francisco Bay Area.
 * Run: node seed-plumbers-sf.js [--dry-run]
 */
...
const ALL_CITIES = [
  { city: "San Francisco", state: "CA", target: 30 },
  { city: "Oakland",       state: "CA", target: 15 },
  { city: "San Jose",      state: "CA", target: 15 },
  { city: "Berkeley",      state: "CA", target: 8  },
  { city: "Fremont",       state: "CA", target: 8  },
  { city: "San Mateo",     state: "CA", target: 8  },
  { city: "Palo Alto",     state: "CA", target: 6  },
  { city: "Sunnyvale",     state: "CA", target: 6  },
  { city: "Santa Clara",   state: "CA", target: 6  },
  { city: "Daly City",     state: "CA", target: 6  },
];
