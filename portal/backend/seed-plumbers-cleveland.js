/**
 * seed-plumbers-cleveland.js
 * Seeds plumbers from Cleveland, OH area.
 * Run: node seed-plumbers-cleveland.js [--dry-run]
 */
...
const ALL_CITIES = [
  { city: "Cleveland",      state: "OH", target: 30 },
  { city: "Akron",          state: "OH", target: 15 },
  { city: "Parma",          state: "OH", target: 8  },
  { city: "Lakewood",       state: "OH", target: 8  },
  { city: "Euclid",         state: "OH", target: 6  },
  { city: "Mentor",         state: "OH", target: 6  },
  { city: "Strongsville",   state: "OH", target: 6  },
  { city: "Lorain",         state: "OH", target: 6  },
];
