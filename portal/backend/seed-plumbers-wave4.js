/**
 * seed-plumbers-wave4.js
 * Seeds ~500 more plumbers from new US cities.
 * Run: node seed-plumbers-wave4.js [--dry-run]
 */
...
const ALL_CITIES = [
  // More Texas
  { city: "Houston",        state: "TX", target: 40 },
  { city: "Austin",         state: "TX", target: 30 },
  { city: "San Antonio",    state: "TX", target: 25 },
  // More California
  { city: "San Diego",      state: "CA", target: 30 },
  { city: "Sacramento",     state: "CA", target: 20 },
  { city: "Long Beach",     state: "CA", target: 12 },
  // More Florida
  { city: "Tampa",          state: "FL", target: 25 },
  { city: "Orlando",        state: "FL", target: 25 },
  { city: "Jacksonville",   state: "FL", target: 15 },
  // More New York
  { city: "Buffalo",        state: "NY", target: 15 },
  // Hawaii
  { city: "Honolulu",       state: "HI", target: 15 },
  // Mississippi
  { city: "Jackson",        state: "MS", target: 10 },
  // West Virginia
  { city: "Charleston",     state: "WV", target: 10 },
  // Maine
  { city: "Portland",       state: "ME", target: 10 },
  // New Hampshire
  { city: "Manchester",     state: "NH", target: 10 },
  // Vermont
  { city: "Burlington",     state: "VT", target: 8  },
  // Delaware
  { city: "Wilmington",     state: "DE", target: 10 },
  // Montana
  { city: "Billings",       state: "MT", target: 8  },
  // Wyoming
  { city: "Cheyenne",       state: "WY", target: 8  },
  // North Dakota
  { city: "Fargo",          state: "ND", target: 8  },
  // South Dakota
  { city: "Sioux Falls",    state: "SD", target: 8  },
  // Alaska
  { city: "Anchorage",      state: "AK", target: 10 },
];
