/**
 * seed-plumbers-wave3.js
 * Seeds ~500 more plumbers from new US cities.
 * Run: node seed-plumbers-wave3.js [--dry-run]
 */
...
const ALL_CITIES = [
  // Virginia
  { city: "Virginia Beach", state: "VA", target: 20 },
  { city: "Richmond",       state: "VA", target: 20 },
  { city: "Arlington",      state: "VA", target: 12 },
  // Missouri
  { city: "St. Louis",      state: "MO", target: 25 },
  { city: "Kansas City",    state: "MO", target: 20 },
  // Indiana
  { city: "Indianapolis",   state: "IN", target: 25 },
  // Wisconsin
  { city: "Milwaukee",      state: "WI", target: 20 },
  // Louisiana
  { city: "New Orleans",    state: "LA", target: 20 },
  { city: "Baton Rouge",    state: "LA", target: 12 },
  // Oklahoma
  { city: "Oklahoma City",  state: "OK", target: 20 },
  { city: "Tulsa",          state: "OK", target: 12 },
  // Kentucky
  { city: "Louisville",     state: "KY", target: 20 },
  // Alabama
  { city: "Birmingham",     state: "AL", target: 15 },
  // South Carolina
  { city: "Charleston",     state: "SC", target: 15 },
  // New Jersey
  { city: "Newark",         state: "NJ", target: 15 },
  // New Mexico
  { city: "Albuquerque",    state: "NM", target: 15 },
  // Utah
  { city: "Salt Lake City", state: "UT", target: 20 },
  // Nebraska
  { city: "Omaha",          state: "NE", target: 15 },
  // Iowa
  { city: "Des Moines",     state: "IA", target: 12 },
  // Kansas
  { city: "Wichita",        state: "KS", target: 12 },
  // Idaho
  { city: "Boise",          state: "ID", target: 12 },
  // Connecticut
  { city: "Hartford",       state: "CT", target: 12 },
  // Rhode Island
  { city: "Providence",     state: "RI", target: 10 },
  // Arkansas
  { city: "Little Rock",    state: "AR", target: 10 },
];
